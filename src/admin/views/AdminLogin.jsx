    ...
    <div className="admin-login-page">
      <div className="login-card-box">
        <div className="login-card-header">
          <div className="login-logo-badge">OC</div>
          <h2 className="login-title">Вход в панель управления</h2>
          <p className="login-subtitle">OpenCart Engine v3.0 • Autolider Marketplace</p>
        </div>
        ...
        <div className="login-footer-hint">
          <span>Тестовый доступ: логин <b>admin</b> / пароль <b>admin</b></span>
        </div>
      </div>
    </div>
  );
