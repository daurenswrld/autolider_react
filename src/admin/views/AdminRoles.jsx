    ...
    <div className="admin-roles-view">
      ...
      <div className="roles-overview-section">
        <h2 className="section-subtitle-title">
          Уровни доступа системы (Роли)
        </h2>
        <div className="roles-preset-grid">
          <div className="role-preset-card admin-role-card">
            <div className="role-preset-header">
              <div className="role-badge-icon admin">
                <ShieldCheck size={22} />
              </div>
              <div
                style={{
              ...
              >
                <h3 className="role-preset-name">Администратор</h3>
                <span className="role-preset-code">Full Access</span>
              </div>
            </div>
            <p className="role-preset-desc">
              Полный доступ ко всем модулям панели управления: Заказы, Товары,
              Категории, Бренды, Клиенты, Баннеры, Склады, Аккаунты сотрудников
              и Настройки системы.
            </p>
            <div className="role-tags-wrap">
              <span className="role-permission-tag red">Все разделы</span>
              <span className="role-permission-tag red">
                Управление сотрудниками
              </span>
              <span className="role-permission-tag red">Настройки</span>
            </div>
          </div>

          <div className="role-preset-card manager-role-card">
            <div className="role-preset-header">
              <div className="role-badge-icon manager">
                <UserCheck size={22} />
              </div>
              <div
                style={{
              ...
              >
                <h3 className="role-preset-name">Менеджер</h3>
                <span className="role-preset-code">Standard Access</span>
              </div>
            </div>
            <p className="role-preset-desc">
              Рабочий доступ для менеджеров отделов: обработка заказов, просмотр
              базы клиентов, редактирование товаров, категорий, брендов и
              рекламных баннеров.
            </p>
            <div className="role-tags-wrap">
              <span className="role-permission-tag blue">Заказы и Клиенты</span>
              <span className="role-permission-tag blue">
                Товары и Категории
              </span>
              <span className="role-permission-tag blue">Баннеры</span>
            </div>
          </div>
        </div>
      </div>
